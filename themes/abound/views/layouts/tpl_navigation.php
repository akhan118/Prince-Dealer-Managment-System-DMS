<div class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
          ...
          <a class="brand" href="<?echo CController::createUrl('/site/index')?>"><?php echo CHtml::encode(Yii::app()->name); ?> <small>DMS</small></a>
...
//                        array('label'=>'Typography', 'url'=>array('/site/page', 'view'=>'typography'),'visible'=>!Yii::app()->user->isGuest),
                        ...
                        array('label'=>'My Account <span class="caret"></span>', 'visible'=>!Yii::app()->user->isGuest,'url'=>'#','itemOptions'=>array('class'=>'dropdown','tabindex'=>"-1"),'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>"dropdown"), 
                        'items'=>array(
                      ...
                      array('label'=>'Vehicle', 'url'=>array('/vehicle'), 'visible'=>!Yii::app()->user->isGuest),
                        array('label'=>'Order Managment', 'url'=>array('/om/order'), 'visible'=>!Yii::app()->user->isGuest),
